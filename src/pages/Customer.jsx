  ...
  return (
    <div className="bg-light  min-vh-100">
      ...
      <div className="container">
        ...
        <h4 className="text text-center">Raise your queries here. </h4>

        {/* card */}
        <div className="row my-5 mx-2 text-center">
          <div className="col-xs-12 col-lg-3 col-md-6 my-1">
            <div
              className="card shadow  cardItem shadow  bg-primary text-dark bg-opacity-25 borders-b"
              style={{ width: 15 + "rem" }}
            >
        ...
        <input
          type="submit"
          className="form-control btn btn-success text-white fw-bolder my-2"
          value="RAISE TICKET"
              ...
              <form onSubmit={createTicket}>
                ...
                <div className="input-group justify-content-center">
                  <div className="m-1">
                    <Button
                      variant="secondary"
                      onClick={() => closeTicketCreationModal()}
                    >
                      Cancel
                    </Button>
                  </div>
